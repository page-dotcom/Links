      ...
      <main>
        <div className="container" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
            ...
            <div className="input-wrapper">
                ...
                {/* STATE INPUT: Muncul pas belum ada hasil */}
                {!showResult ? (
                  ...
                  /* STATE RESULT: Muncul pas link beres dipendekkin */
            ...
            {/* AREA RECENT SECTION GUE HAPUS TOTAL BIAR GAK ELOR */}
                ...
                <div className="feature-grid-fixed">
                    <div className="feat-col">
                        <div className="icon-wrap">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"><path d="M14 9V5a3 3 0 0 0-3-3l-4 9v11h11.28a2 2 0 0 0 2-1.7l1.38-9a2 2 0 0 0-2-2.3zM7 22H4a2 2 0 0 1-2-2v-7a2 2 0 0 1 2-2h3"></path></svg>
                        </div>
                        <h4>Easy</h4>
                    ...
                    <div className="feat-col">
                        <div className="icon-wrap">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"></path></svg>
                        </div>
                        <h4>Secure</h4>
                    ...
                    <div className="feat-col">
                        <div className="icon-wrap">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"><line x1="18" y1="20" x2="18" y2="10"></line><line x1="12" y1="20" x2="12" y2="4"></line><line x1="6" y1="20" x2="6" y2="14"></line></svg>
                        </div>
                        <h4>Statistics</h4>
                    ...
                    <div className="feat-col">
                        <div className="icon-wrap">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"></circle><line x1="4.93" y1="4.93" x2="19.07" y2="19.07"></line></svg>
                        </div>
                        <h4>Reliable</h4>
                    ...
                    <div className="feat-col">
                        <div className="icon-wrap">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"><rect x="4" y="2" width="16" height="12" rx="2" ry="2"></rect><rect x="4" y="14" width="8" height="6" rx="2" ry="2"></rect><line x1="12" y1="20" x2="12" y2="20"></line><line x1="2" y1="20" x2="2" y2="20"></line><line x1="22" y1="20" x2="22" y2="20"></line></svg>
                        </div>
                        <h4>Devices</h4>

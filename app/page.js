...
export default function Home() {
  ...
  // FUNGSI COOKIE NATIVE (GAK PERLU INSTALL NPM)
            ...
            <div className="input-wrapper">
                {!showResult ? (
                  ...
                  <div id="state-result" className="result-box" style={{display:'flex'}}>
                      ...
                      <button className="btn-black copy" style={{background:'var(--accent)'}} onClick={() => navigator.clipboard.writeText(hasil)}>
                          Copy Link
                      </button>
                    ...
                    {recentLinks.map((item, index) => (
                        <div className="link-row" key={index}>
                            ...
                            <div className="actions">
                                <button className="btn-icon" onClick={() => navigator.clipboard.writeText(item.short)}>
                                    <span className="material-symbols-rounded">content_copy</span>
                                </button>
                                <Link href={`/stats?slug=${item.slug}`} className="btn-icon">
                                    <span className="material-symbols-rounded">bar_chart</span>
                                </Link>
                                <button className="btn-icon" onClick={() => deleteSingle(index)} style={{color:'red'}}>
                ...
                <div className="article-white-box">
                    <div className="article-inner">
                        ...
                        <div className="article-item">
                            ...
                            <p>Your shortened URLs can be used in publications, documents, advertisements, blogs, forums, instant messages, and other locations. Track statistics for your business and projects by monitoring the number of hits from your URL with our <a href="#">click counter</a>.</p>
                        </div>
                    </div>
                </div>
